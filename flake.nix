        ...
        let
          ...
          mkDevShell = hpkgs: with pkgs; mkShell {
            ...
            shellHook = ''
              ...
              # export PATH=$HOME/life/project/haskell-language-server/dist-newstyle/build/x86_64-linux/ghc-9.6.3/haskell-language-server-2.7.0.0/x/haskell-language-server/build/haskell-language-server:$PATH
              # export PATH=$HOME/life/project/haskell-language-server/dist-newstyle/build/x86_64-linux/ghc-9.6.3/haskell-language-server-2.7.0.0/x/haskell-language-server-wrapper/build/haskell-language-server-wrapper:$PATH
